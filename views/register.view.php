	...
	<div class="bg-white dark:bg-gray-900 shadow-md rounded-lg px-8 py-6 max-w-md">
		...
		<form action="" method="post">
			<div class="mb-4">
				...
				<input type="username" name = "username" id="username" class="shadow-sm rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" placeholder="username" required>
			</div>
			<div class="mb-4">
			...
			<div class="flex items-center justify-between mb-4">
				...
				<a href="/login"
					class="text-xs text-indigo-500 hover:text-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Already have an account? Login.</a>
			</div>
